...
class MavrosOffboardPosctlTest(MavrosTestCommon):
    ...
    def setUp(self):
        ...
        self.raw_setpoint_pub = rospy.Publisher('/uav0/mavros/setpoint_raw/local', PositionTarget, queue_size=1)
        ...
        self.raw_setpoint_sub = rospy.Subscriber('/uav0/mavros/setpoint_raw/bridge', PositionTarget, self.raw_callback)
