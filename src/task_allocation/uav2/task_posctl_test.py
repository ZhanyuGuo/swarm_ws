...
class MavrosOffboardPosctlTest(MavrosTestCommon):
    ...
    def setUp(self):
        ...
        self.raw_setpoint_pub = rospy.Publisher("/uav2/mavros/setpoint_raw/local", PositionTarget, queue_size=1)
        ...
        # self.uav2_pos_sub = rospy.Subscriber('/uav2/mavros/local_position/pose', PoseStamped, self.pos_callback)
        self.raw_setpoint_sub = rospy.Subscriber("/uav2/mavros/setpoint_raw/bridge", PositionTarget, self.raw_callback)
